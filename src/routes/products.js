...
const { addProduct, getProducts, deleteProduct, updateProduct, addToCart, viewCart } = require('../controllers/productsController');
...
router.get('/view-cart/:salon_id', authenticateToken, roleAuthorization(['CUSTOMER']), viewCart);
